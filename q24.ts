...
let my_name:string = "talat"
let your_name:string= "rimsha"
let n1:number= 4;
let n2:number= 5;
...
console.log("Is my_name == `talat` ? i predict true");
console.log(my_name == "talat");

console.log("Is my_name != talat ? i predict false");
console.log(my_name == "rimsha");
...
// Tests using the lower case function
console.log("Is my_name lowercase == 'talat'? I predict True.");
console.log(my_name.toLowerCase() == "talat");

console.log("Is my_name lowercase != 'talat'? I predict false.");
console.log(my_name.toLowerCase()=="talat");
